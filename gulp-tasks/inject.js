...
gulp.task('injectAssets', function () {
    return gulp.src('./**/*.html')
        .pipe(inject(gulp.src(['./assets/vendors/js/core.js', './assets/vendors/js/vendor.addons.js', './assets/vendors/iconfonts/mdi/css/materialdesignicons.css', './assets/vendors/css/vendor.addons.css'], {
            read: false
        }), {
            name: 'plugins',
            relative: true
...
gulp.task('replacePath', function () {
    gulp.src('src/*/*.html', {
        ...
        .pipe(replace('href="admin/', 'href="../admin/'))
        .pipe(replace('href="index.html"', 'href="index.html"'))
        .pipe(gulp.dest('.'));

    gulp.src(['src/*/demo/*.html', 'src/*/pages/*.html'], {
            base: "./"
        })
        .pipe(replace('src="assets/images/', 'src="../../assets/images/'))
        .pipe(replace('href="demo/', 'href="../demo/'))
